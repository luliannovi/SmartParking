...
def main():
    ...
    root.add_resource(['gate_in'], EntryGate(gateID='id3', descrizione='entry gate', timesleep=10))
    root.add_resource(['gate_out'], ExitGate(gateID='id4', descrizione='exit gate', timesleep=10))
